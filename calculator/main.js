...
import { Multiplication, Addition, Division, Substraction, } from "./arithmatic.js";
let questions = await inquirer
    ...
    if (answers.operation == "Addition") {
        ...
        console.log(`Subtraction of ${answers.num1} - ${answers.num2} is ${subtract} `);
    }
    else if (answers.operation == "Multiplication") {
        let Multiply = Multiplication(answers.num1, answers.num2);
        console.log(`Multiplication of ${answers.num1} * ${answers.num2} is ${Multiply} `);
    }
    else if (answers.operation == "Division") {
        let Divide = Division(answers.num1, answers.num2);
        console.log(`Multiplication of ${answers.num1} / ${answers.num2} is ${Divide} `);
    }
});
